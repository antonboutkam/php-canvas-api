...
class Assignment extends CanvasObject
{
    ...
    public ?string $originalLtiResourceLinkId = null;
    ...
    */
     ...
     * @return string|null
     */
    public function getOriginalLtiResourceLinkId():?string{
    ...
    public function setOriginalLtiResourceLinkId(int|string|null $originalLtiResourceLinkId): static
    {
        ...
        if (is_int($originalLtiResourceLinkId)) {
            $originalLtiResourceLinkId = (string)$originalLtiResourceLinkId;
        }
